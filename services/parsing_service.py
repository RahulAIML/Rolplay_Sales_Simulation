...
def parse_raw_meeting_text(raw_text):
    ...
    # --- FALLBACK: If no Session ID found, generate one ---
    ...
    for line in lines:
        ...
        # Using relaxed regex to catch more name formats (e.g. names with brackets)
        ...
        if mode == "summary":
            ...
            # Fallback for structured text that missed regex
