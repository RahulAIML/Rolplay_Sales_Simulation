            ...
            try:
                ...
                if self.is_postgres:
                    alter_cmds = [
                        ...
                        "ALTER TABLE meetings ADD COLUMN IF NOT EXISTS survey_status TEXT DEFAULT 'pending'"
                    ]
                else:
                    ...
                    if 'survey_status' not in cols:
                        cur.execute("ALTER TABLE meetings ADD COLUMN survey_status TEXT DEFAULT 'pending'")
